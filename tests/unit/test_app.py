            ...
            "sections": [
                {
                    ...
                    "freshness_metric_items": [
                        {"key": "updated_at", "label": "Updated At", "type": "timestamp", "value": "2026-04-19T20:00:01+09:00"},
                    ...
                    "metric_items": [
                        {"key": "buy_count", "label": "Buy Count", "type": "count", "format_hint": "integer", "severity": "info", "value": 4},
                        {"key": "sell_count", "label": "Sell Count", "type": "count", "format_hint": "integer", "severity": "info", "value": 3},
                        {"key": "stop_loss_count", "label": "Stop Loss Count", "type": "count", "format_hint": "integer", "severity": "critical", "value": 1},
                        {"key": "realized_pnl", "label": "Realized PnL", "type": "pnl", "format_hint": "signed_currency", "severity": "info", "value": 12500.0},
                        {"key": "unrealized_pnl", "label": "Unrealized PnL", "type": "pnl", "format_hint": "signed_currency", "severity": "warning", "value": -3200.0},
                ...
                },
                {
                    ...
                    "metric_items": [
                        ...
                        {"key": "learning_signal_count", "label": "Signal Count", "type": "count", "format_hint": "integer", "severity": "info", "value": 3},
                        {"key": "learning_fill_count", "label": "Fill Count", "type": "count", "format_hint": "integer", "severity": "info", "value": 2},
                        {"key": "last_signal_recorded_at", "label": "Last Signal At", "type": "timestamp", "format_hint": "datetime", "severity": "info", "value": "2026-04-19T20:00:00+09:00"},
                        {"key": "last_fill_recorded_at", "label": "Last Fill At", "type": "timestamp", "format_hint": "datetime", "severity": "info", "value": "2026-04-19T20:00:01+09:00"},
                    ],
                },
                {
                    "key": "recovery",
                    ...
                    "freshness_metric_items": [
                        {"key": "updated_at", "label": "Updated At", "type": "timestamp", "value": "2026-04-19T20:00:04+09:00"},
                    ...
                    "metric_items": [
                        ...
                        {"key": "last_restart_detected_at", "label": "Last Restart At", "type": "timestamp", "format_hint": "datetime", "severity": "info", "value": "2026-04-19T20:00:03+09:00"},
                        {"key": "last_recovery_completed_at", "label": "Last Recovery At", "type": "timestamp", "format_hint": "datetime", "severity": "info", "value": "2026-04-19T20:00:04+09:00"},
                    ],
                },
                {
                    "key": "promotion",
                    ...
                    "freshness_metric_items": [
                        {"key": "updated_at", "label": "Updated At", "type": "timestamp", "value": "2026-04-19T20:00:02+09:00"},
                        {"key": "age_sec", "label": "Age Seconds", "type": "duration_sec", "value": 298},
                    ...
                    "metric_items": [
                        ...
                        {"key": "last_promotion_reviewed_at", "label": "Last Promotion Review At", "type": "timestamp", "format_hint": "datetime", "severity": "info", "value": "2026-04-19T20:00:02+09:00"},
                    ],
                },
            ],
            "section_state_label": {
