...
class SummaryStubService:
    def build(self, **kwargs):
        ...
        payload["dashboard_structure_lookup_object"] = {
            "structure_map": payload["dashboard_structure_map"],
            "items_object": payload["dashboard_structure_items_object"],
            "item_lookup_object": payload["dashboard_structure_item_lookup_object"],
        }
        payload["dashboard_structure_lookup_items"] = [
            {
                "key": "structure_map",
                "value": payload["dashboard_structure_map"],
            },
            {
                "key": "items_object",
                "value": payload["dashboard_structure_items_object"],
            },
            {
                "key": "item_lookup_object",
                "value": payload["dashboard_structure_item_lookup_object"],
            },
        ]
        payload["dashboard_structure_lookup_item_map"] = {
            item["key"]: item
            for item in payload["dashboard_structure_lookup_items"]
        }
        payload["dashboard_structure_lookup_item_index_map"] = {
            item["key"]: index
            for index, item in enumerate(payload["dashboard_structure_lookup_items"])
        }
        payload["dashboard_structure_lookup_item_order"] = [
            item["key"] for item in payload["dashboard_structure_lookup_items"]
        ]
        payload["dashboard_structure_lookup_item_meta"] = {
            "count": len(payload["dashboard_structure_lookup_items"]),
            "keys": payload["dashboard_structure_lookup_item_order"],
            "index_map": payload["dashboard_structure_lookup_item_index_map"],
        }
        ...
        payload["dashboard_structure_lookup_object"]["item_index_map"] = payload[
        ...
        payload["dashboard_structure_lookup_meta"] = {
            "keys": list(payload["dashboard_structure_lookup_object"].keys()),
            "count": len(payload["dashboard_structure_lookup_object"]),
        }
        payload["dashboard_structure_lookup_meta_map"] = {
            key: payload["dashboard_structure_lookup_meta"][key]
            for key in payload["dashboard_structure_lookup_meta"]
        }
        payload["dashboard_structure_lookup_meta_items"] = [
            {
                "key": key,
                "value": payload["dashboard_structure_lookup_meta"][key],
            }
            for key in payload["dashboard_structure_lookup_meta"]
        ]
        ...
        payload["dashboard_structure_lookup_meta_item_order"] = [
            item["key"] for item in payload["dashboard_structure_lookup_meta_items"]
        ]
        payload["dashboard_structure_lookup_meta_item_index_map"] = {
            item["key"]: index
        ...
        payload["dashboard_structure_lookup_meta_item_meta_object"] = {
            "meta": payload["dashboard_structure_lookup_meta_item_meta"],
        }
        payload["dashboard_structure_lookup_meta_items_object"] = {
            "items": payload["dashboard_structure_lookup_meta_items"],
            "item_map": payload["dashboard_structure_lookup_meta_item_map"],
        ...
        payload["dashboard_structure_lookup_meta_items_meta"] = {
            "keys": list(payload["dashboard_structure_lookup_meta_items_object"].keys()),
            "count": len(payload["dashboard_structure_lookup_meta_items_object"]),
        }
        payload["dashboard_structure_lookup_meta_items_meta_map"] = {
            key: payload["dashboard_structure_lookup_meta_items_meta"][key]
            for key in payload["dashboard_structure_lookup_meta_items_meta"]
        }
        payload["dashboard_structure_lookup_meta_items_meta_items"] = [
            {
                "key": key,
                "value": payload["dashboard_structure_lookup_meta_items_meta"][key],
            }
            for key in payload["dashboard_structure_lookup_meta_items_meta"]
        ]
        payload["dashboard_structure_lookup_meta_items_meta_item_map"] = {
            item["key"]: item
            for item in payload["dashboard_structure_lookup_meta_items_meta_items"]
        }
        payload["dashboard_structure_lookup_meta_items_meta_item_order"] = [
            item["key"] for item in payload["dashboard_structure_lookup_meta_items_meta_items"]
        ]
        payload["dashboard_structure_lookup_meta_items_meta_item_meta"] = {
            "count": len(payload["dashboard_structure_lookup_meta_items_meta_items"]),
            "keys": payload["dashboard_structure_lookup_meta_items_meta_item_order"],
        }
        payload["dashboard_structure_lookup_meta_items_meta_item_meta_object"] = {
            "meta": payload["dashboard_structure_lookup_meta_items_meta_item_meta"],
        }
        payload["dashboard_structure_lookup_meta_items_meta_item_meta_map"] = {
        ...
        payload["dashboard_structure_lookup_meta_items_meta_item_meta_item_map"] = {
            item["key"]: item
            for item in payload["dashboard_structure_lookup_meta_items_meta_item_meta_items"]
        }
        payload["dashboard_structure_lookup_meta_items_meta_object"] = {
            "meta": payload["dashboard_structure_lookup_meta_items_meta"],
            "meta_map": payload["dashboard_structure_lookup_meta_items_meta_map"],
            "meta_items": payload["dashboard_structure_lookup_meta_items_meta_items"],
            "meta_item_map": payload["dashboard_structure_lookup_meta_items_meta_item_map"],
            "meta_item_order": payload["dashboard_structure_lookup_meta_items_meta_item_order"],
            "meta_item_meta": payload["dashboard_structure_lookup_meta_items_meta_item_meta"],
            "meta_item_meta_object": payload["dashboard_structure_lookup_meta_items_meta_item_meta_object"],
            "meta_item_meta_map": payload["dashboard_structure_lookup_meta_items_meta_item_meta_map"],
            "meta_item_meta_items": payload["dashboard_structure_lookup_meta_items_meta_item_meta_items"],
            "meta_item_meta_item_map": payload["dashboard_structure_lookup_meta_items_meta_item_meta_item_map"],
        }
        payload["dashboard_structure_lookup_meta_object"] = {
            "meta": payload["dashboard_structure_lookup_meta"],
            "meta_map": payload["dashboard_structure_lookup_meta_map"],
            "meta_items": payload["dashboard_structure_lookup_meta_items"],
            "meta_item_map": payload["dashboard_structure_lookup_meta_item_map"],
            "meta_item_order": payload["dashboard_structure_lookup_meta_item_order"],
            "meta_item_meta": payload["dashboard_structure_lookup_meta_item_meta"],
            "meta_item_meta_object": payload["dashboard_structure_lookup_meta_item_meta_object"],
            "meta_items_object": payload["dashboard_structure_lookup_meta_items_object"],
            "meta_items_meta": payload["dashboard_structure_lookup_meta_items_meta"],
            "meta_items_meta_object": payload["dashboard_structure_lookup_meta_items_meta_object"],
            "meta_items_meta_map": payload["dashboard_structure_lookup_meta_items_meta_map"],
            "meta_items_meta_items": payload["dashboard_structure_lookup_meta_items_meta_items"],
            "meta_items_meta_item_map": payload["dashboard_structure_lookup_meta_items_meta_item_map"],
            "meta_items_meta_item_order": payload["dashboard_structure_lookup_meta_items_meta_item_order"],
            "meta_items_meta_item_meta": payload["dashboard_structure_lookup_meta_items_meta_item_meta"],
            "meta_items_meta_item_meta_object": payload["dashboard_structure_lookup_meta_items_meta_item_meta_object"],
            "meta_items_meta_item_meta_map": payload["dashboard_structure_lookup_meta_items_meta_item_meta_map"],
            "meta_items_meta_item_meta_items": payload["dashboard_structure_lookup_meta_items_meta_item_meta_items"],
            "meta_items_meta_item_meta_item_map": payload["dashboard_structure_lookup_meta_items_meta_item_meta_item_map"],
        }
        payload["dashboard_structure_object"] = {
            ...
            "structure_map": payload["dashboard_structure_map"],
            "lookup_object": payload["dashboard_structure_lookup_object"],
            "lookup_meta": payload["dashboard_structure_lookup_meta"],
            "lookup_meta_map": payload["dashboard_structure_lookup_meta_map"],
            "lookup_meta_items": payload["dashboard_structure_lookup_meta_items"],
            ...
            "lookup_meta_items_meta": payload["dashboard_structure_lookup_meta_items_meta"],
            "lookup_meta_items_meta_object": payload["dashboard_structure_lookup_meta_items_meta_object"],
            "lookup_meta_items_meta_map": payload["dashboard_structure_lookup_meta_items_meta_map"],
            "lookup_meta_items_meta_items": payload["dashboard_structure_lookup_meta_items_meta_items"],
            "lookup_meta_items_meta_item_map": payload["dashboard_structure_lookup_meta_items_meta_item_map"],
            "lookup_meta_items_meta_item_order": payload["dashboard_structure_lookup_meta_items_meta_item_order"],
            "lookup_meta_items_meta_item_meta": payload["dashboard_structure_lookup_meta_items_meta_item_meta"],
            "lookup_meta_items_meta_item_meta_object": payload["dashboard_structure_lookup_meta_items_meta_item_meta_object"],
            "lookup_meta_items_meta_item_meta_map": payload["dashboard_structure_lookup_meta_items_meta_item_meta_map"],
            "lookup_meta_items_meta_item_meta_items": payload["dashboard_structure_lookup_meta_items_meta_item_meta_items"],
            "lookup_meta_items_meta_item_meta_item_map": payload["dashboard_structure_lookup_meta_items_meta_item_meta_item_map"],
            "lookup_meta_object": payload["dashboard_structure_lookup_meta_object"],
            "items": payload["dashboard_structure_items"],
            "item_map": payload["dashboard_structure_item_map"],
            "item_order": payload["dashboard_structure_item_order"],
            "item_meta": payload["dashboard_structure_item_meta"],
        ...
        payload["dashboard_object"] = {
            ...
            "structure_lookup_meta": payload["dashboard_structure_lookup_meta"],
            "structure_lookup_meta_map": payload["dashboard_structure_lookup_meta_map"],
            "structure_lookup_meta_items": payload["dashboard_structure_lookup_meta_items"],
            ...
            "structure_lookup_meta_items_meta": payload["dashboard_structure_lookup_meta_items_meta"],
            "structure_lookup_meta_items_meta_object": payload["dashboard_structure_lookup_meta_items_meta_object"],
            "structure_lookup_meta_items_meta_map": payload["dashboard_structure_lookup_meta_items_meta_map"],
            "structure_lookup_meta_items_meta_items": payload["dashboard_structure_lookup_meta_items_meta_items"],
            "structure_lookup_meta_items_meta_item_map": payload["dashboard_structure_lookup_meta_items_meta_item_map"],
            "structure_lookup_meta_items_meta_item_order": payload["dashboard_structure_lookup_meta_items_meta_item_order"],
            "structure_lookup_meta_items_meta_item_meta": payload["dashboard_structure_lookup_meta_items_meta_item_meta"],
            "structure_lookup_meta_items_meta_item_meta_object": payload["dashboard_structure_lookup_meta_items_meta_item_meta_object"],
            "structure_lookup_meta_items_meta_item_meta_map": payload["dashboard_structure_lookup_meta_items_meta_item_meta_map"],
            "structure_lookup_meta_items_meta_item_meta_items": payload["dashboard_structure_lookup_meta_items_meta_item_meta_items"],
            "structure_lookup_meta_items_meta_item_meta_item_map": payload["dashboard_structure_lookup_meta_items_meta_item_meta_item_map"],
            "structure_lookup_meta_object": payload["dashboard_structure_lookup_meta_object"],
            ...
            "structure_lookup_item_index_map": payload["dashboard_structure_lookup_item_index_map"],
