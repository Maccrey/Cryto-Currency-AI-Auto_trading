    ...
    summary = service.build(
        ...
        sections=[
            ...
            },
            {
                ...
                "state_object": {"state_label": "HARD_STOP", "severity": "critical", "state_message": "하드스톱이 활성화되어 수동 개입이 필요합니다.", "recommended_action": "하드스톱 해제 전까지 수동 점검과 원인 분석을 진행하세요."},
