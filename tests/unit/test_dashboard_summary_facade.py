...
def _with_section_card_objects(payload: dict[str, object]) -> dict[str, object]:
    ...
    normalized["dashboard_navigation"] = {
    ...
    normalized["dashboard_navigation_items"] = normalized["dashboard_navigation"]["panels"]
    normalized["dashboard_navigation_map"] = {
        panel["key"]: panel
        for panel in normalized["dashboard_navigation"]["panels"]
    }
    normalized["dashboard_navigation_meta"] = {
    ...
    normalized["dashboard_structure"] = {
        ...
        "navigation": normalized["dashboard_navigation"],
        "navigation_items": normalized["dashboard_navigation_items"],
        "navigation_map": normalized["dashboard_navigation_map"],
        "navigation_meta": normalized["dashboard_navigation_meta"],
        "navigation_object": normalized["dashboard_navigation_object"],
    }
    normalized["dashboard_structure_meta"] = {
        "keys": list(normalized["dashboard_structure"].keys()),
        "count": len(normalized["dashboard_structure"]),
    }
    normalized["dashboard_structure_meta_object"] = {
        "meta": normalized["dashboard_structure_meta"],
    }
    normalized["dashboard_structure_map"] = {
        key: normalized["dashboard_structure"][key]
        for key in normalized["dashboard_structure"]
    }
    normalized["dashboard_structure_items"] = [
        {
            "key": key,
            "value": normalized["dashboard_structure"][key],
        }
        for key in normalized["dashboard_structure"]
    ]
    normalized["dashboard_structure_item_map"] = {
        item["key"]: item
    ...
    normalized["dashboard_structure_item_lookup_object"] = {
    ...
    normalized["dashboard_structure_items_object"] = {
        ...
        "item_map": normalized["dashboard_structure_item_map"],
        "item_index_map": normalized["dashboard_structure_item_index_map"],
        "lookup": normalized["dashboard_structure_item_lookup_object"],
    ...
    normalized["dashboard_structure_lookup_object"] = {
        "structure_map": normalized["dashboard_structure_map"],
        "items_object": normalized["dashboard_structure_items_object"],
        "item_lookup_object": normalized["dashboard_structure_item_lookup_object"],
    }
    normalized["dashboard_structure_lookup_items"] = [
        {
            "key": "structure_map",
            "value": normalized["dashboard_structure_map"],
        },
        {
            "key": "items_object",
            "value": normalized["dashboard_structure_items_object"],
        },
        {
            "key": "item_lookup_object",
            "value": normalized["dashboard_structure_item_lookup_object"],
        },
    ]
    normalized["dashboard_structure_lookup_item_map"] = {
        item["key"]: item
        for item in normalized["dashboard_structure_lookup_items"]
    }
    normalized["dashboard_structure_lookup_item_index_map"] = {
        item["key"]: index
        for index, item in enumerate(normalized["dashboard_structure_lookup_items"])
    }
    normalized["dashboard_structure_lookup_item_order"] = [
        item["key"] for item in normalized["dashboard_structure_lookup_items"]
    ]
    normalized["dashboard_structure_lookup_item_meta"] = {
        "count": len(normalized["dashboard_structure_lookup_items"]),
        "keys": normalized["dashboard_structure_lookup_item_order"],
        "index_map": normalized["dashboard_structure_lookup_item_index_map"],
    }
    normalized["dashboard_structure_lookup_item_meta_object"] = {
        "meta": normalized["dashboard_structure_lookup_item_meta"],
    }
    normalized["dashboard_structure_lookup_item_lookup_object"] = {
        "item_map": normalized["dashboard_structure_lookup_item_map"],
        "item_index_map": normalized["dashboard_structure_lookup_item_index_map"],
    }
    normalized["dashboard_structure_lookup_items_object"] = {
        "items": normalized["dashboard_structure_lookup_items"],
        "item_map": normalized["dashboard_structure_lookup_item_map"],
        "item_index_map": normalized["dashboard_structure_lookup_item_index_map"],
        "lookup": normalized["dashboard_structure_lookup_item_lookup_object"],
        "item_order": normalized["dashboard_structure_lookup_item_order"],
        "item_meta": normalized["dashboard_structure_lookup_item_meta"],
        "item_meta_object": normalized["dashboard_structure_lookup_item_meta_object"],
    }
    ...
    normalized["dashboard_structure_lookup_object"]["item_index_map"] = normalized[
        "dashboard_structure_lookup_item_index_map"
    ]
    normalized["dashboard_structure_lookup_object"]["item_order"] = normalized[
        "dashboard_structure_lookup_item_order"
    ]
    normalized["dashboard_structure_lookup_object"]["item_meta"] = normalized[
        "dashboard_structure_lookup_item_meta"
    ]
    normalized["dashboard_structure_lookup_object"]["item_meta_object"] = normalized[
        "dashboard_structure_lookup_item_meta_object"
    ]
    normalized["dashboard_structure_lookup_object"]["item_lookup_object"] = normalized[
        "dashboard_structure_lookup_item_lookup_object"
    ]
    normalized["dashboard_structure_lookup_object"]["items_object"] = normalized[
        "dashboard_structure_lookup_items_object"
    ]
    normalized["dashboard_structure_lookup_meta"] = {
    ...
    normalized["dashboard_structure_lookup_meta_item_map"] = {
        item["key"]: item
        for item in normalized["dashboard_structure_lookup_meta_items"]
    }
    normalized["dashboard_structure_lookup_meta_item_order"] = [
        item["key"] for item in normalized["dashboard_structure_lookup_meta_items"]
    ]
    normalized["dashboard_structure_lookup_meta_item_index_map"] = {
        item["key"]: index
        for index, item in enumerate(normalized["dashboard_structure_lookup_meta_items"])
    }
    normalized["dashboard_structure_lookup_meta_item_lookup_object"] = {
        "item_map": normalized["dashboard_structure_lookup_meta_item_map"],
        "item_index_map": normalized["dashboard_structure_lookup_meta_item_index_map"],
    }
    normalized["dashboard_structure_lookup_meta_item_meta"] = {
    ...
    normalized["dashboard_structure_lookup_meta_items_object"] = {
        "items": normalized["dashboard_structure_lookup_meta_items"],
        "item_map": normalized["dashboard_structure_lookup_meta_item_map"],
        "item_order": normalized["dashboard_structure_lookup_meta_item_order"],
        "item_index_map": normalized["dashboard_structure_lookup_meta_item_index_map"],
        "lookup": normalized["dashboard_structure_lookup_meta_item_lookup_object"],
        "item_meta": normalized["dashboard_structure_lookup_meta_item_meta"],
        "item_meta_object": normalized["dashboard_structure_lookup_meta_item_meta_object"],
    }
    normalized["dashboard_structure_lookup_meta_items_meta"] = {
        "keys": list(normalized["dashboard_structure_lookup_meta_items_object"].keys()),
        "count": len(normalized["dashboard_structure_lookup_meta_items_object"]),
    }
    normalized["dashboard_structure_lookup_meta_items_meta_map"] = {
        key: normalized["dashboard_structure_lookup_meta_items_meta"][key]
        for key in normalized["dashboard_structure_lookup_meta_items_meta"]
    }
    normalized["dashboard_structure_lookup_meta_items_meta_items"] = [
        {
            "key": key,
            "value": normalized["dashboard_structure_lookup_meta_items_meta"][key],
        }
        for key in normalized["dashboard_structure_lookup_meta_items_meta"]
    ]
    normalized["dashboard_structure_lookup_meta_items_meta_item_map"] = {
        item["key"]: item
    ...
    normalized["dashboard_structure_lookup_meta_items_meta_item_meta"] = {
        "count": len(normalized["dashboard_structure_lookup_meta_items_meta_items"]),
        "keys": normalized["dashboard_structure_lookup_meta_items_meta_item_order"],
    }
    normalized["dashboard_structure_lookup_meta_items_meta_item_meta_object"] = {
        "meta": normalized["dashboard_structure_lookup_meta_items_meta_item_meta"],
    }
    normalized["dashboard_structure_lookup_meta_items_meta_item_meta_map"] = {
        key: normalized["dashboard_structure_lookup_meta_items_meta_item_meta"][key]
        for key in normalized["dashboard_structure_lookup_meta_items_meta_item_meta"]
    }
    normalized["dashboard_structure_lookup_meta_items_meta_item_meta_items"] = [
        {
            "key": key,
            "value": normalized["dashboard_structure_lookup_meta_items_meta_item_meta"][key],
        }
        for key in normalized["dashboard_structure_lookup_meta_items_meta_item_meta"]
    ]
    normalized["dashboard_structure_lookup_meta_items_meta_item_meta_item_map"] = {
        item["key"]: item
        for item in normalized["dashboard_structure_lookup_meta_items_meta_item_meta_items"]
    }
    normalized["dashboard_structure_lookup_meta_items_meta_object"] = {
        ...
        "meta_item_meta": normalized["dashboard_structure_lookup_meta_items_meta_item_meta"],
        "meta_item_meta_object": normalized["dashboard_structure_lookup_meta_items_meta_item_meta_object"],
        "meta_item_meta_map": normalized["dashboard_structure_lookup_meta_items_meta_item_meta_map"],
        "meta_item_meta_items": normalized["dashboard_structure_lookup_meta_items_meta_item_meta_items"],
        "meta_item_meta_item_map": normalized["dashboard_structure_lookup_meta_items_meta_item_meta_item_map"],
    }
    normalized["dashboard_structure_lookup_meta_object"] = {
        ...
        "meta_items_object": normalized["dashboard_structure_lookup_meta_items_object"],
        "meta_items_meta": normalized["dashboard_structure_lookup_meta_items_meta"],
        "meta_items_meta_object": normalized["dashboard_structure_lookup_meta_items_meta_object"],
        ...
        "meta_items_meta_item_meta": normalized["dashboard_structure_lookup_meta_items_meta_item_meta"],
        "meta_items_meta_item_meta_object": normalized["dashboard_structure_lookup_meta_items_meta_item_meta_object"],
        "meta_items_meta_item_meta_map": normalized["dashboard_structure_lookup_meta_items_meta_item_meta_map"],
        "meta_items_meta_item_meta_items": normalized["dashboard_structure_lookup_meta_items_meta_item_meta_items"],
        "meta_items_meta_item_meta_item_map": normalized["dashboard_structure_lookup_meta_items_meta_item_meta_item_map"],
    }
    normalized["dashboard_structure_object"] = {
        "structure": normalized["dashboard_structure"],
        "meta": normalized["dashboard_structure_meta"],
        "meta_object": normalized["dashboard_structure_meta_object"],
        "structure_map": normalized["dashboard_structure_map"],
        ...
        "lookup_meta_item_index_map": normalized["dashboard_structure_lookup_meta_item_index_map"],
        "lookup_meta_item_lookup_object": normalized["dashboard_structure_lookup_meta_item_lookup_object"],
        ...
        "lookup_meta_items_object": normalized["dashboard_structure_lookup_meta_items_object"],
        "lookup_meta_items_meta": normalized["dashboard_structure_lookup_meta_items_meta"],
        "lookup_meta_items_meta_object": normalized["dashboard_structure_lookup_meta_items_meta_object"],
        ...
        "lookup_meta_items_meta_item_meta": normalized["dashboard_structure_lookup_meta_items_meta_item_meta"],
        "lookup_meta_items_meta_item_meta_object": normalized["dashboard_structure_lookup_meta_items_meta_item_meta_object"],
        "lookup_meta_items_meta_item_meta_map": normalized["dashboard_structure_lookup_meta_items_meta_item_meta_map"],
        "lookup_meta_items_meta_item_meta_items": normalized["dashboard_structure_lookup_meta_items_meta_item_meta_items"],
        "lookup_meta_items_meta_item_meta_item_map": normalized["dashboard_structure_lookup_meta_items_meta_item_meta_item_map"],
        ...
        "item_meta": normalized["dashboard_structure_item_meta"],
        "item_meta_object": normalized["dashboard_structure_item_meta_object"],
        "lookup_item_meta": normalized["dashboard_structure_lookup_item_meta"],
        "lookup_item_meta_object": normalized["dashboard_structure_lookup_item_meta_object"],
        "lookup_item_lookup_object": normalized["dashboard_structure_lookup_item_lookup_object"],
        "lookup_items_object": normalized["dashboard_structure_lookup_items_object"],
        "items_object": normalized["dashboard_structure_items_object"],
    }
    normalized["dashboard_object"] = {
        ...
        "navigation_object": normalized["dashboard_navigation_object"],
        "structure": normalized["dashboard_structure"],
        "structure_meta": normalized["dashboard_structure_meta"],
        "structure_meta_object": normalized["dashboard_structure_meta_object"],
        "structure_map": normalized["dashboard_structure_map"],
        ...
        "structure_lookup_meta_item_index_map": normalized["dashboard_structure_lookup_meta_item_index_map"],
        "structure_lookup_meta_item_lookup_object": normalized["dashboard_structure_lookup_meta_item_lookup_object"],
        ...
        "structure_lookup_meta_items_object": normalized["dashboard_structure_lookup_meta_items_object"],
        "structure_lookup_meta_items_meta": normalized["dashboard_structure_lookup_meta_items_meta"],
        "structure_lookup_meta_items_meta_object": normalized["dashboard_structure_lookup_meta_items_meta_object"],
        ...
        "structure_lookup_meta_items_meta_item_meta": normalized["dashboard_structure_lookup_meta_items_meta_item_meta"],
        "structure_lookup_meta_items_meta_item_meta_object": normalized["dashboard_structure_lookup_meta_items_meta_item_meta_object"],
        "structure_lookup_meta_items_meta_item_meta_map": normalized["dashboard_structure_lookup_meta_items_meta_item_meta_map"],
        "structure_lookup_meta_items_meta_item_meta_items": normalized["dashboard_structure_lookup_meta_items_meta_item_meta_items"],
        "structure_lookup_meta_items_meta_item_meta_item_map": normalized["dashboard_structure_lookup_meta_items_meta_item_meta_item_map"],
        ...
        "structure_lookup_item_index_map": normalized["dashboard_structure_lookup_item_index_map"],
        "structure_lookup_item_order": normalized["dashboard_structure_lookup_item_order"],
        "structure_lookup_item_meta": normalized["dashboard_structure_lookup_item_meta"],
        "structure_lookup_item_meta_object": normalized["dashboard_structure_lookup_item_meta_object"],
        "structure_lookup_item_lookup_object": normalized["dashboard_structure_lookup_item_lookup_object"],
        "structure_lookup_items_object": normalized["dashboard_structure_lookup_items_object"],
        ...
        "structure_item_lookup_object": normalized["dashboard_structure_item_lookup_object"],
        ...
        "structure_items_object": normalized["dashboard_structure_items_object"],
        "structure_object": normalized["dashboard_structure_object"],
    }
    return normalized
