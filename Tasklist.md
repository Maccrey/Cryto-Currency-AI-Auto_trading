...
## 15. Phase 11 - 데모 룰 다변화 및 손절 스위칭 최적화

- [x] [Fail] 데모 룰 M, N, O 추가 테스트 및 15개 확장 여부 검증
- [x] [Fail] 섀도 포트폴리오 손절 발생 시 리더 즉시 스위칭 및 승격 조건 바이패스 검증
- [x] [Code] 룰 M, N, O 다중 변형 구현 및 variants.py 확장
- [x] [Code] evaluate() 내 손절 감지 및 실시간 강제 리더 스위칭 로직 구현
